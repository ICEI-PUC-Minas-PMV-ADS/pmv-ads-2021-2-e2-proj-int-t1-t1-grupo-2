...
<html lang="pt-br">
    ...
    dynamic logado = null;
			...
			if((XVar)(XSession.Session.KeyExists("logado"))  && (XVar)(XSession.Session["logado"] == true))
			{
				...
				if(XSession.Session["perfil"] == "cliente")
				{
					MVCFunctions.HeaderRedirect("./buscar-restaurantes.php");
				}
			}
			else
			{
...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-light">
			...
			if(logado == false)
			{
				MVCFunctions.Echo("<button onclick=\"window.location.href = './cadastro-empresario.html'\" class=\"btn btn-cadastro-usuario\" type=\"button\" id=\"btn_cadastre-se\">Cadastre-se</button>\r\n  <button href=\"\" class=\"btn btn-login\" type=\"button\">Entrar</button>\r\n                ");
			}
			else
			{
                ...
                <div class="form-rest">
                    <form action="../controller_bd_restaurante.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-check form-check-inline mb-3 col-md-2">                                
                                <input class="input-check" type="checkbox" name="diasDaSemanaRestaurante[]" value="Terça-feira">
                                <label class="label-check" for="tercaFeira">Terça-feira</label>                                
                            </div>
                            <div class="form-check form-check-inline mb-3 col-md-2">
                            ...
                            <div class="form-check form-check-inline mb-3 col-md-2">
                                <input class="input-check" type="checkbox" name="diasDaSemanaRestaurante[]" value="Sábado">
                                <label class="label-check" for="sabado">Sábado</label>
                            </div>
                            <div class="form-check form-check-inline mb-3 col-md-2">
                        ...
                        <div class="row"> 
                            ...
                            <div class="form-check form-check-inline mb-3 col-md-2">
                                <input class="input-check" type="checkbox" name="formasDePagamento[]" value="Crédito">
                                <label class="label-check" for="credito">Crédito</label>
                            </div>
                            <div class="form-check form-check-inline mb-3 col-md-2">
                                <input class="input-check" type="checkbox" name="formasDePagamento[]" value="Débito">
                                <label class="label-check" for="debito">Débito</label>
                            </div>                            
                        </div>                     
